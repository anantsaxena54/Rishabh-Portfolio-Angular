...
export const PROJECTS: readonly Project[] = [
  // Cinematography
  { title: 'Nestasia Kitchen', cat: 'cine', brand: 'Nestasia', img: 'assets/logos/cine/01_nestasia/nestasia kitchen.jpg', video: 'assets/logos/cine/01_nestasia/NESTASIA X SANYA_SCRIPT 3 (HORIZONTAL)_HR.mp4' },
  { title: 'VK Magic Tricks',  cat: 'cine', brand: 'Ocean',    img: 'assets/logos/cine/02_ocean/virat magic.jpg',         video: 'assets/logos/cine/02_ocean/VK & Rohit_MAGIC TRICKS_11.27.2023.mp4' },
  ...
  { title: 'Nestasia Room',    cat: 'cine', brand: 'Nestasia', img: 'assets/logos/cine/01_nestasia/nestasia room.jpg',    video: 'assets/logos/cine/01_nestasia/NESTASIA X SANYA_SCRIPT 2 (HORIZONTAL)_HR_1.mp4' },
  { title: 'VK Clone',         cat: 'cine', brand: 'Ocean',    img: 'assets/logos/cine/02_ocean/virat clone.jpg',         video: 'assets/logos/cine/02_ocean/VK x Clone_30.0_Horizontal.mp4' },
  { title: 'Neha x Angad',     cat: 'cine', brand: 'Giva',     img: 'assets/logos/cine/04_giva/neha giva.jpg',            video: 'assets/logos/cine/04_giva/NEHA X ANGAD_01.15.2024_TRAILER.mp4' },
  ...
  { title: 'Sara Bags',        cat: 'edit', brand: 'Zouk',         img: 'assets/logos/edit/03_zouk/zouk sara.jpg',               video: 'assets/logos/edit/03_zouk/VIDEO 14 ZOUK x SARA POSING WITH DIFFERENT BAGS_07.17.2023.mp4' },
  ...
  { title: 'Bread Range',      cat: 'vfx',  brand: 'Bakers Dozen', img: 'assets/logos/vfx/03_bakers dozen/bakers clone.jpg',     video: 'assets/logos/vfx/03_bakers dozen/BAKERS DOZEN x SOHA_BREAD RANGE.mp4' },
  ...
  { title: 'Flash Gordon',     cat: 'vfx',  brand: 'Ocean',        img: 'assets/logos/vfx/01_ocean/ocean flash1.png',            video: 'assets/logos/vfx/01_ocean/Virat x ED_flash_gordon.mp4' },
  { title: 'Cake Range',       cat: 'vfx',  brand: 'Bakers Dozen', img: 'assets/logos/vfx/03_bakers dozen/bakers queen.jpg',     video: 'assets/logos/vfx/03_bakers dozen/BAKERS DOZEN x SOHA_CAKE RANGE.mp4' },
  ...
  { title: 'Styleup AI Study', cat: 'vfx',  brand: 'Case Study',   img: 'assets/logos/vfx/02_case study/AI casestudy .png',      video: 'assets/logos/vfx/02_case study/Styleup AI Case Study_04.03.25.mp4' },
  ...
  { title: 'Trunativ Peach',   cat: 'vfx',  brand: 'Trunative',    img: 'assets/logos/vfx/09_trunative/trunative hologram.jpg',  video: 'assets/logos/vfx/09_trunative/TRUNATIVxPEACH.mp4' },
