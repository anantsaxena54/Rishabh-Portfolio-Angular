...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function N0(){return new ti({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rf(),fragmentShader:`
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function O0(){return new ti({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rf(),fragmentShader:`
